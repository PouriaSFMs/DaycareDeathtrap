	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 8:
					#if PSYCH_WATERMARKS
					addMoreText('Doing this');
					#end
					case 9:
					#if PSYCH_WATERMARKS
					addMoreText('With my life ?');
					#end
					case 10:
					deleteCoolText();
					case 11:
				...
				case 18:
					...
					case 19:
					#if PSYCH_WATERMARKS
					addMoreText('Touch some Grass');
					#end
					case 20:
					deleteCoolText();
					case 21:
					#if PSYCH_WATERMARKS
					createCoolText(['Shoutouts to Old Hunter']);
					#end
					case 22:
					deleteCoolText();
				case 23:
				...
				// credTextShit.text += '\nNight';
				case 28:
					addMoreText('Deathtrap'); // credTextShit.text += '\nFunkin';
